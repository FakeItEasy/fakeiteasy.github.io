...
const utils_1 = __nccwpck_require__(3242);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(5126);
const file_command_1 = __nccwpck_require__(5282);
const utils_1 = __nccwpck_require__(3242);
const os = __importStar(__nccwpck_require__(2037));
const path = __importStar(__nccwpck_require__(1017));
const oidc_utils_1 = __nccwpck_require__(3080);
/**
 ...
 * Summary exports
 */
var summary_1 = __nccwpck_require__(5595);
Object.defineProperty(exports, "summary", ({ enumerable: true, get: function () { return summary_1.summary; } }));
/**
 * @deprecated use core.summary
 */
var summary_2 = __nccwpck_require__(5595);
Object.defineProperty(exports, "markdownSummary", ({ enumerable: true, get: function () { return summary_2.markdownSummary; } }));
/**
 * Path exports
 */
var path_utils_1 = __nccwpck_require__(3483);
...
const os = __importStar(__nccwpck_require__(2037));
const uuid_1 = __nccwpck_require__(6535);
const utils_1 = __nccwpck_require__(3242);
...
const http_client_1 = __nccwpck_require__(6447);
const auth_1 = __nccwpck_require__(5893);
const core_1 = __nccwpck_require__(7387);
class OidcClient {
...
const pm = __importStar(__nccwpck_require__(5006));
const tunnel = __importStar(__nccwpck_require__(7532));
var HttpCodes;
(function (HttpCodes) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__export(__nccwpck_require__(1602));
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const fs_1 = __nccwpck_require__(7147);
const debug_1 = __importDefault(__nccwpck_require__(6601));
...
module.exports = __nccwpck_require__(4218)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(1147);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	...
	module.exports = __nccwpck_require__(5164);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(5727);
...
const tty = __nccwpck_require__(6224);
const hasFlag = __nccwpck_require__(7335);
...
var _v = _interopRequireDefault(__nccwpck_require__(8382));

var _v2 = _interopRequireDefault(__nccwpck_require__(6994));

var _v3 = _interopRequireDefault(__nccwpck_require__(617));

var _v4 = _interopRequireDefault(__nccwpck_require__(8217));

var _nil = _interopRequireDefault(__nccwpck_require__(7136));

var _version = _interopRequireDefault(__nccwpck_require__(1755));

var _validate = _interopRequireDefault(__nccwpck_require__(5815));

var _stringify = _interopRequireDefault(__nccwpck_require__(7714));

var _parse = _interopRequireDefault(__nccwpck_require__(9932));
...
var _rng = _interopRequireDefault(__nccwpck_require__(9841));
...
var _v = _interopRequireDefault(__nccwpck_require__(7400));

var _md = _interopRequireDefault(__nccwpck_require__(1655));
...
var _sha = _interopRequireDefault(__nccwpck_require__(3856));
...
var _regex = _interopRequireDefault(__nccwpck_require__(2581));
...
/* harmony export */   "y": () => (/* binding */ getLatestStableTag)
/* harmony export */ });
...
// EXTERNAL MODULE: ../../../../../../../Thomas Levesque/Personal/Projects/fakeiteasy.github.io/.github/actions/latest-stable-tag/node_modules/@kwsites/file-exists/dist/index.js
var dist = __nccwpck_require__(5145);
// EXTERNAL MODULE: ../../../../../../../Thomas Levesque/Personal/Projects/fakeiteasy.github.io/.github/actions/latest-stable-tag/node_modules/debug/src/index.js
var src = __nccwpck_require__(6601);
;// CONCATENATED MODULE: external "child_process"
const external_child_process_namespaceObject = __WEBPACK_EXTERNAL_createRequire(import.meta.url)("child_process");
// EXTERNAL MODULE: ../../../../../../../Thomas Levesque/Personal/Projects/fakeiteasy.github.io/.github/actions/latest-stable-tag/node_modules/@kwsites/promise-deferred/dist/index.js
var promise_deferred_dist = __nccwpck_require__(4069);
;// CONCATENATED MODULE: ../../../../../../../Thomas Levesque/Personal/Projects/fakeiteasy.github.io/.github/actions/latest-stable-tag/node_modules/simple-git/dist/esm/index.js
...
;// CONCATENATED MODULE: ../../../../../../../Thomas Levesque/Personal/Projects/fakeiteasy.github.io/.github/actions/latest-stable-tag/get-tags.js
...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(7387);
/* harmony import */ var _get_latest_stable_tag_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(1766);
/* harmony import */ var _get_tags_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(257);
...
async function run() {
    try {
      const repoPath = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('repo-path');
      const tags = await (0,_get_tags_js__WEBPACK_IMPORTED_MODULE_1__/* .getTags */ .N)(repoPath);
      const latestTag = (0,_get_latest_stable_tag_js__WEBPACK_IMPORTED_MODULE_2__/* .getLatestStableTag */ .y)(tags);
      _actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput("latest-tag", latestTag);
    } catch (error) {
